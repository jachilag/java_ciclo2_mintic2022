...
/**
 * This abstract class contains some functions useful for a lot of programs wich
 * there are not any one defined to default in Java lenguage.
...
public abstract class funProp {
     ...
     * @return this is a string, in which could be aplied parse to convert the
     *         dataType
     */
     ...
     */
    public static void printArray(float[] arreglo) {
        printArray(toStr(arreglo));
    }
    ...
    public static void printArray(String[] arreglo) {
        ...
        for (int i = 0; i < arreglo.length; i++) {
            text = arreglo[i] + repetNtimes(" ", space);
            number = (i == arreglo.length - 1) ? (text + "\n") : text;
